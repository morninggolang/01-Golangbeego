...
func AddApp(m *models.App) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}
...
// Id doesn't exist
func GetAppById(id int) (v *models.App, err error) {
	o := orm.NewOrm()
	v = &models.App{Id: id}
...
func GetAllApp(query map[string]string, fields []string, sortby []string, order []string,
	...
	o := orm.NewOrm()
	qs := o.QueryTable(new(models.App))
	// query k=v
	for k, v := range query {
...
func UpdateAppById(m *models.App) (err error) {
	o := orm.NewOrm()
	v := models.App{Id: m.Id}
...
func DeleteApp(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&models.App{Id: id}); err == nil {
